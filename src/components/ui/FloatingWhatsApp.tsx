...
export function FloatingWhatsApp() {
  ...
  return (
    <motion.a
      ...
      className={`fixed bottom-4 md:bottom-8 ${lang === 'ar' ? 'left-4 md:left-8' : 'right-4 md:right-8'} z-40 flex items-center justify-center w-[48px] h-[48px] md:w-[54px] md:h-[54px] bg-[#25D366] text-white rounded-full shadow-[0_4px_14px_0_rgba(37,211,102,0.39)] hover:shadow-[0_6px_20px_rgba(37,211,102,0.6)] hover:scale-110 transition-all duration-300`}
